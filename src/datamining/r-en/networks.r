...
escolaridade <- read.csv("~/Documentos/Source-Python/startupbr/src/datamining/csv-en/analysis/escolaridade.csv", sep=";")
...
escolaridade %>%
  ...
  ylab("Founders' Degrees % (quantity)") + labs(fill = "Degree") +
  theme_classic()
