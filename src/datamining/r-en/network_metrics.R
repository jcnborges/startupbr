...
centralities %>%
  ...
  summarize(
    ...
    scale_x_continuous(name = "Year", breaks = c(2006, 2010, 2014, 2019), limits = c(2006, 2019)) +
    ylab("Mean Spatial Degree") + labs(color = "Range (km)") +
    theme_classic() + 
...
df %>%
  ...
  ylab("Degree Centrality") + xlab("Continuos GIC") + 
  theme_classic()
